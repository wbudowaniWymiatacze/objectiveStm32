...
#define USART3_PART__REMAP_APB1				RCC_APB1Periph_USART3
#define USART3_PART__REMAP_APB2				RCC_APB2Periph_AFIO | RCC_APB2Periph_GPIOC
// USART3 fully remapped
#define USART3_PORT_FULL_REMAP				3
#define USART3_RX_PIN_FULL_REMAP			9
#define USART3_TX_PIN_FULL_REMAP			8
#define USART3_FULL__REMAP_APB1				RCC_APB1Periph_USART3
#define USART3_FULL__REMAP_APB2				RCC_APB2Periph_AFIO | RCC_APB2Periph_GPIOD
