...
CXX_DEFS += -DSTM32F10X_CL -DUSE_STDPERIPH_DRIVER -DSTM32F107VCXX

# C definitions
C_DEFS += -DSTM32F10X_CL -DUSE_STDPERIPH_DRIVER -DSTM32F107VCXX

# include directories
INC_DIRS += Boards/boards/f1xx
INC_DIRS += Boards/boards/f1xx/f107
...
SRC_DIRS += Boards/boards/f1xx/connectivityLine
